...
public class RED_BACKSTAGE_MAX extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder givePlayerFirstSample = drive.actionBuilder(new Pose2d(10, -30, Math.toRadians(270)))
        ...
        TrajectoryActionBuilder goPark = drive.actionBuilder(new Pose2d(15, -20, Math.toRadians(270)))
                .strafeToLinearHeading(new Vector2d(73, -50), Math.toRadians(90));
